...
use CoderslabBundle\Form\AuthorType;
...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CoderslabBundle:Author')->findAll();
     ...
     * @Method("POST")
     * @Template("CoderslabBundle:Author:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CoderslabBundle:Author')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CoderslabBundle:Author:edit.html.twig")
     */
