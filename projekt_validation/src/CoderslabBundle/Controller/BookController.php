...
use CoderslabBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CoderslabBundle:Book')->findAll();
     ...
     * @Method("POST")
     * @Template("CoderslabBundle:Book:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CoderslabBundle:Book')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CoderslabBundle:Book:edit.html.twig")
     */
